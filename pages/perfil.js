            ...
            <div className="md:p-8 p-2 bg-white rounded-t-md md:flex items-center md:justify-between">
                <div className="flex gap-3 items-center sm:space-x-6">
                    ...
                    <div className="flex flex-col space-y-4 justify-center">
                        <div>
                            <p className="text-2xl font-semibold text-gray-900">{datos.nombre} {datos.apellido}</p>
                ...
                <Link legacyBehavior href='/tiposangre'>
                      <a 
                        className="bg-gray-100 hover:bg-gray-200 mt-5 md:mt-0 py-2 px-5 font-bold rounded-md"
                      >
                          Continuar Registro
                      </a>
                  </Link>
